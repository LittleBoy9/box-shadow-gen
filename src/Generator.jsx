            ...
            <Container fluid className="main_container">
                ...
                <Row className="main_row">
                    <Col sm={12} lg={6} className="output">
                        <div className="box" style={{ boxShadow: `${checkOn ? "inset":""} ${hori}px ${vart}px ${blur}px ${color}` }}>
                        </div>
                    </Col>
                    <Col sm={12} lg={6} className="control" >
                        ...
                        <input type="range"
                            ...
                            value={blur}
                            onChange={(e) =>
                                set_blur(e.target.value)
                            }
                        /><hr />

                        <label htmlFor="color">Color</label>
                        <span className="chip color_chip">
                            {color}
                        </span>
                        <input type="color"
                            id="color"
                        ...
                        <div className="switch">
                            <label>
                                Outline
                                <input type="checkbox" checked={checkOn} onChange={()=> set_checkOn(!checkOn) }/>
                        ...
                        <div className="css_text">
                            <Alert variant='success'>
                                box-shadow : {`${checkOn ? "inset":""} ${hori}px ${vart}px ${blur}px ${color}`}
                            </Alert>
                        </div>             
                </Row>
            </Container>
